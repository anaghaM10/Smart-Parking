...
if(mysqli_num_rows($result_cust)>0){
  echo '<div class="alert alert-warning" role="alert"><span class="glyphicon glyphicon-warning-sign"></span> You have already booked a slot! <span class="glyphicon glyphicon-warning-sign"></span> </div>';
}else{
