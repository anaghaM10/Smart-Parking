...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    <h4 class="Head"><?=$parking_street; ?></h4>
    <hr>
    <ul class="list-group">
      <li class="list-group-item"><span class="glyphicon glyphicon-home"></span> <?=$parking_street; ?> (<?=$parking_remaining;?>)</li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?=$parking_street; ?> Reservation</h4>
      </div>
      <div class="modal-body">
        <ul class="list-group">
          ...
          <li class="list-group-item"><span class="glyphicon glyphicon-credit-card"></span> Rs. <?=$parking_price; ?> Per Slot Per Hour</li>
          <li class="list-group-item " ><span class="glyphicon">Rs. </span> <p class="total" id="total<?=$parking_id; ?>"><?=$parking_slot; ?> </p></li>
