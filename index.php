...
$(".modal-transparent").on('hidden.bs.modal', function () {
  ...
  <body>
    ...
    <div class="row">
      <div class="container">
         ...
         <div class="col-md-4">
                 <h1 class="colors heading">SMART PARKING</h1>
                 <hr>
         </div>
         <div class="col-md-4"></div>
      </div>
  ...
  <div class="form-group">
      ...
      <input type="text" name="name" id="name"  class="text ui-widget-content ui-corner-all sign-input">
  </div>    

  <div class="form-group">
      <label for="email">Email</label>
      <input type="email" id="email" class = "sign-input" name="email" placeholder="" class="text ui-widget-content ui-corner-all"  onchange="email_validate(this.value);" required>
            <p id="emailstatus"></p>
  </div>  

   <div class="form-group">
      <label for="password">Password</label>
     <input type="password" id="password" name="password" class = "sign-input" placeholder="" class="text ui-widget-content ui-corner-all" required>
  </div>   

   <div class="form-group">
      <label for="password">Confirm Password</label>
      <input type="password" class="text ui-widget-content ui-corner-all sign-input"  id="password_confirm" name="password_confirm" placeholder=""  onkeyup="checkPass(); return false;" required>
  </div>   

<button type="submit" id="regBtn" class="form-control sign-input" name="register">create account</button>
        </div>
        </form>
      </div>
    ...
    <div class="row">
      <div class="container">
         ...
         <div class="col-md-4">
           ...
           <form enctype="multipart/form" action="index.php" method="POST" id="login-form">
             ...
             <button type="submit" name="login">login</button>
              ...
              <a href="admin_login.php" style="text-decoration:none;color:white;">Admin?</a>
           </form>
         </div>
         <div class="col-md-4"> </div>
    </div>
