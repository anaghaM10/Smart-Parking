      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="logout.php" style="background-color:#000000;">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <ul class="left-links">
                      ...
                      <li><a  href="admin_request.php"><i class="fa fa-hand-o-right" aria-hidden="true"></i>Bookings</a></li>  
                    </ul>
                   </div>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
           <p class = "description">Hello Admin!</p>
              <div class="row">
