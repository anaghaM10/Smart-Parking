...
<?php
$sel="SELECT `requests`.`id`, `slots`, `hours`, `cost`, `customer`, `time`,`street` FROM `requests`,`parkings` WHERE `parkings`.`id`=`requests`.`parking_id`";
...
<tr>
<td><?php echo $i; ?></td>
<td ><strong style="data-transform:uppercase !important;"><?php echo $street; ?></strong></td>
